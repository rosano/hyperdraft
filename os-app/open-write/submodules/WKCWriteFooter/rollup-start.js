...
const WKCWriteFooter = new RollupStart({
	...
	props: Object.assign({
		WKCWriteFooterDispatchStorage: (function _WKCWriteFooterDispatchStorage () {
			window.TestWKCWriteFooterDispatchStorage.innerHTML = parseInt(window.TestWKCWriteFooterDispatchStorage.innerHTML) + 1;
		}),
		_WKCWriteFooterDispatchExport: (function __WKCWriteFooterDispatchExport () {}),
		_WKCWriteFooterDispatchImport: (function __WKCWriteFooterDispatchImport () {}),
