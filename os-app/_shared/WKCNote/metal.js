...
export const WKCNoteMetalWrite = async function(storageClient, inputData) {
	...
	return await storageClient.wikiavec.wkc_documents.writeObject(inputData.WKCNoteID, inputData);
};
...
export const WKCNoteMetalRead = async function(storageClient, inputData) {
	...
	return WKCNoteModelPostJSONParse(await storageClient.wikiavec.wkc_documents.readObject(inputData));
};
