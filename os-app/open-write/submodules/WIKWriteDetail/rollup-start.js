...
const WIKWriteDetail = new RollupStart({
	...
	props: Object.assign({
		...
		WIKWriteDetailDispatchJump: (function _WIKWriteDetailDispatchJump (inputData) {
			window.TestWIKWriteDetailDispatchJump.innerHTML = parseInt(window.TestWIKWriteDetailDispatchJump.innerHTML) + 1;
		}),
		...
		WIKWriteDetailDispatchRetract: (function _WIKWriteDetailDispatchRetract (inputData) {
			window.TestWIKWriteDetailDispatchRetract.innerHTML = parseInt(window.TestWIKWriteDetailDispatchRetract.innerHTML) + 1;
		}),
