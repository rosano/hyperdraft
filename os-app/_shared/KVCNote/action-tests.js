...
describe('KVCNoteActionBacklinksMap', function test_KVCNoteActionBacklinksMap() {

	it('returns object', async function() {
		deepEqual(await mainModule.KVCNoteActionBacklinksMap(KVCTestingStorageClient), {});
	});

	it('includes if no links', async function() {
		const item = await mainModule.KVCNoteActionCreate(KVCTestingStorageClient, kTesting.StubNoteObject());
		deepEqual(await mainModule.KVCNoteActionBacklinksMap(KVCTestingStorageClient), {
			bravo: [],
		});
	...
	it('includes if broken links', async function() {
		await mainModule.KVCNoteActionCreate(KVCTestingStorageClient, Object.assign(kTesting.StubNoteObject(), {
			KVCNoteBody: 'alfa\n[[bravo]]'
		}));
		deepEqual(await mainModule.KVCNoteActionBacklinksMap(KVCTestingStorageClient), {
			alfa: [],
	...
	it('includes if unresolved links', async function() {
		const item1 = await mainModule.KVCNoteActionCreate(KVCTestingStorageClient, Object.assign(kTesting.StubNoteObject(), {
			KVCNoteBody: 'alfa\n[[bravo]]'
		}));
		const item2 = await mainModule.KVCNoteActionCreate(KVCTestingStorageClient, Object.assign(kTesting.StubNoteObject(), {
			KVCNoteBody: 'bravo'
		}));
		deepEqual(await mainModule.KVCNoteActionBacklinksMap(KVCTestingStorageClient), {
			alfa: [],
	...
	it('includes if resolved links', async function() {
		const item1 = await mainModule.KVCNoteActionCreate(KVCTestingStorageClient, Object.assign(kTesting.StubNoteObject(), {
			KVCNoteBody: 'alfa\n[[bravo]]'
		}));
		const item2 = await mainModule.KVCNoteActionCreate(KVCTestingStorageClient, Object.assign(kTesting.StubNoteObject(), {
